"""One-shot: get captcha, save, then take verify code as arg"""
...
captcha_data = r.read()
path = r'C:\Users\Admin\.qclaw\workspace\ccgp_jixi\captcha_now.png'
with open(path, 'wb') as f:
    f.write(captcha_data)

# Step 3: Get verify code from CLI arg
verify_code = sys.argv[1]

# Step 4: Query (must use same cookie session!)
...
print(f'code={j["code"]} total={total}')
if j['code'] == '200':
