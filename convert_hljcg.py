...
_CAT_RULES = [
    (r'维(修|护|保)|养护|运维|值守|检修', '维保集成'),
    (r'软件|系统|平台|信息化|网络|数据|信息|智能|智慧|电子', '信息化建设'),
    (r'集(成|采)|安装|施工|工程|改造|建设', '集成工程'),
    (r'设备|硬件|电脑|笔记本|服务器|打印机|扫描|复印|投影|大屏|LED|监控|摄像头|交换机|路由器|防火墙|存储|UPS|空调|家具|办公桌|办公椅|柜|门|窗|床|车辆|汽车|仪器|试剂|药品|医疗|机', '硬件采购'),
]
